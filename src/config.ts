...
export const BUILDINGS: Record<string, Building> = {
  ...
  aronoff:     { name: 'Aronoff Center for Design & Art',             center: [-84.51817996210889, 39.13433426000876], floors: [2,3,4,5,6],       elevatorNodes: [], entranceNodes: [], accessibleEntranceNodes: [], apiKey: 'aronoff' },
  artsci:      { name: 'Arts & Sciences Hall',                        center: [-84.51914563201682, 39.131863468061795],floors: [1],               elevatorNodes: [], entranceNodes: [], accessibleEntranceNodes: [], apiKey: 'artsci' },
  ...
  blegen:      { name: 'Carl Blegen Library',                         center: [-84.51934098443131, 39.12958090288538], floors: [1],               elevatorNodes: [], entranceNodes: [], accessibleEntranceNodes: [], apiKey: 'blegen' },
  baseball:    { name: 'UC Baseball Field',                           center: [-84.51370743009456, 39.13016559114516], floors: [1],               elevatorNodes: [], entranceNodes: [], accessibleEntranceNodes: [], apiKey: 'baseball' },
  ...
  crosley:     { name: 'Crosley Tower',                               center: [-84.51671492419757, 39.13455654727545], floors: [1],               elevatorNodes: [], entranceNodes: [], accessibleEntranceNodes: [], apiKey: 'crosley' },
  ...
  dyers:       { name: 'Teachers-Dyer Complex',                       center: [-84.51863197602383, 39.13042132369668], floors: [1],               elevatorNodes: [], entranceNodes: [], accessibleEntranceNodes: [], apiKey: 'dyers' },
  ...
  emery:       { name: 'Mary Emery Hall',                             center: [-84.51789815695886, 39.1303875174853],  floors: [1],               elevatorNodes: [], entranceNodes: [], accessibleEntranceNodes: [], apiKey: 'emery' },
  frenchw:     { name: 'French Hall',                                 center: [-84.51305821376505, 39.13241250641286], floors: [1],               elevatorNodes: [], entranceNodes: [], accessibleEntranceNodes: [], apiKey: 'frenchw' },
  ...
  langsam:     { name: 'Walter C. Langsam Library',                   center: [-84.51570566739038, 39.13418909028243], floors: [4,5,6],           elevatorNodes: [], entranceNodes: [], accessibleEntranceNodes: [], apiKey: 'langsam' },
  law:         { name: 'College of Law Building',                     center: [-84.5136542262,     39.13476248008203], floors: [1],               elevatorNodes: [], entranceNodes: [], accessibleEntranceNodes: [], apiKey: 'law' },
  lindhall:    { name: 'Carl H. Lindner Hall',                        center: [-84.51447679629442, 39.13379067791746], floors: [0,1,2,3,4],       elevatorNodes: [], entranceNodes: [], accessibleEntranceNodes: [], apiKey: 'lindhall' },
  lndnrctr:    { name: 'Richard E. Lindner Center',                   center: [-84.51503579504217, 39.1311145018997],  floors: [1,2,3,4,5,6,7,8], elevatorNodes: [], entranceNodes: [], accessibleEntranceNodes: [], apiKey: 'lndnrctr' },
  ...
  mcmicken:    { name: 'McMicken Hall',                               center: [-84.51914221815957, 39.131871165618605],floors: [1,2,3,4,5],       elevatorNodes: [], entranceNodes: [], accessibleEntranceNodes: [], apiKey: 'mcmicken' },
  ...
  rhodes:      { name: 'James A. Rhodes Hall',                        center: [-84.5162434522422,  39.132945638406966],floors: [3,4,5,6,7,8,9],   elevatorNodes: [], entranceNodes: [], accessibleEntranceNodes: [], apiKey: 'rhodes' },
  rievschl:    { name: 'George R. Rieveschl Hall',                    center: [-84.51693465876146, 39.1339700017044],  floors: [4,5,6,7,8,9],     elevatorNodes: [], entranceNodes: [], accessibleEntranceNodes: [], apiKey: 'rievschl' },
  schneidr:    { name: 'Herman Schneider Hall',                       center: [-84.51219152169142, 39.13229575815134], floors: [1],               elevatorNodes: [], entranceNodes: [], accessibleEntranceNodes: [], apiKey: 'schneidr' },
  ...
  shoe:        { name: 'Myrl H. Shoemaker Multipurpose Center',       center: [-84.51406348593618, 39.131213349497244],floors: [1,2,3],           elevatorNodes: [], entranceNodes: [], accessibleEntranceNodes: [], apiKey: 'shoe' },
  ...
  swift:       { name: 'Swift Hall',                                  center: [-84.51741254563956, 39.13245979765452], floors: [5,6,7,8],         elevatorNodes: null, entranceNodes: [], accessibleEntranceNodes: [], apiKey: 'swift' },
  tennis:      { name: 'Tennis Court',                                center: [-84.51568358381813, 39.12994625124256], floors: [1],               elevatorNodes: [], entranceNodes: [], accessibleEntranceNodes: [], apiKey: 'tennis' },
  ...
  turner:      { name: 'Darwin Turner Hall',                          center: [-84.51158195616489, 39.13253556660143], floors: [1],               elevatorNodes: [], entranceNodes: [], accessibleEntranceNodes: [], apiKey: 'turner' },
  ...
  wolfson:     { name: 'Erwin S. Wolfson Center',                     center: [-84.5181774462442,  39.1341524710393],  floors: [4,5,6],           elevatorNodes: [], entranceNodes: [], accessibleEntranceNodes: [], apiKey: 'wolfson' },
